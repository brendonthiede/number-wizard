...
The Tens Hen. Quest 2 Encounter. Spell out the egg stack; the generator cannot count. It came back with eight eggs, two columns of four. Left as is: a fifth row would collide with the raised wing, and nothing in play depends on the count.
